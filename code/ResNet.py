...
def wide_resnet50_2(pretrained=False,  **kwargs):
    ...
    if pretrained:
        pretrained_dict = model_zoo.load_url(model_urls["wide_resnet50_2"])
...
def Backbone_ResNet101_in1(pretrained=True):
    if pretrained:
        print("The backbone model loads the pretrained parameters...")
...
def Backbone_WResNet50_in3(pretrained=True):
    if pretrained:
        print("The backbone model loads the pretrained parameters...")
...
def Backbone_WResNet50_in1(pretrained=True):
    if pretrained:
        print("The backbone model loads the pretrained parameters...")
    net = wide_resnet50_2(pretrained=pretrained)
    net.conv1 = nn.Conv2d(1, 64, kernel_size=7, stride=2, padding=3, bias=False)
